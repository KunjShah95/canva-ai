        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black transition-colors duration-500 relative overflow-hidden">
            ...
            <div className="w-full max-w-md px-6 relative z-10 animate-fade-in">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-xl font-bold uppercase tracking-widest text-ink dark:text-white">Create Account</h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm">Join the next generation of designers</p>
                </div>
                ...
                <div className="bg-white/80 dark:bg-[#111]/90 backdrop-blur-xl border border-gray-100 dark:border-white/10 rounded-3xl p-8 shadow-2xl shadow-gray-200/50 dark:shadow-black/50">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400">Full Name</label>
                            <input
                                type="text"
                                value={name}
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400">Confirm Password</label>
                            <input
                                type="password"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 bg-brand hover:bg-brand-dark text-white rounded-xl text-[11px] font-bold uppercase tracking-[0.2em] transition-all shadow-lg hover:shadow-brand/25 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed mt-4"
                        >
                            {loading ? (
